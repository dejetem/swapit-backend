...
export default class EnvironmentConfigs {
  ...
  static getDatabaseURL(): string {
    const MONGODB_USERNAME: string | undefined = EnvironmentConfigs.inProduction
      ? process.env.SWAP_IT_MONGODB_USERNAME
      : process.env.SWAP_IT_DEV_MONGODB_USERNAME;

    const MONGODB_PASSWORD: string | undefined = EnvironmentConfigs.inProduction
      ? process.env.SWAP_IT_MONGODB_PASSWORD
      : process.env.SWAP_IT_DEV_MONGODB_PASSWORD;

    const MONGODB_DATABASE_NAME: string | undefined =
      EnvironmentConfigs.inProduction
        ? process.env.SWAP_IT_MONGODB_DATABASE_NAME
        : process.env.SWAP_IT_DEV_MONGODB_DATABASE_NAME;

    const MONGODB_DATABASE_HOST: string | undefined =
      EnvironmentConfigs.inProduction
        ? process.env.SWAP_IT_MONGODB_DATABASE_HOST
  ...
  static getAppName(): string {
    return process.env.SWAP_IT_APP_NAME || "SWAP_IT api";
  }
  ...
  static getServerURL(): string {
    return EnvironmentConfigs.inProduction
      ? process.env.SWAP_IT_SERVER_URL || ""
